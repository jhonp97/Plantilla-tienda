...
export interface GetInvoiceByOrderIdInput {
  orderId: string;
}

export interface GetInvoiceByOrderIdResult {
  id: string;
...
export class GetInvoiceByOrderIdUseCase {
  ...
  async execute(input: GetInvoiceByOrderIdInput): Promise<GetInvoiceByOrderIdResult | null> {
