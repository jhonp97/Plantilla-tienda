...
- Name: specs\edge-cases.spec.ts >> Edge Cases and Error Handling >> Stock shows low stock warning
- Location: e2e\specs\edge-cases.spec.ts:33:3

# Error details

```
Error: locator.count: Unexpected token "=" while parsing css selector "[data-testid="low-stock-warning"], text=Pocas unidades". Did you mean to CSS.escape it?
```
