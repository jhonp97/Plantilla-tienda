...
- Name: specs\customer-journey.spec.ts >> Customer Complete Journey >> Guest can add product to cart
- Location: e2e\specs\customer-journey.spec.ts:27:3
...
Locator: locator('[data-testid="add-to-cart-button"]')
Expected: visible
Timeout: 5000ms
