...
- Name: specs\customer-journey.spec.ts >> Customer Complete Journey >> Logged user can view order details
- Location: e2e\specs\customer-journey.spec.ts:87:3
...
Locator: [data-testid="empty-orders-message"], text=No tienes pedidos, text=No orders yet
Expected: visible
Error: Unexpected token "=" while parsing css selector "[data-testid="empty-orders-message"], text=No tienes pedidos, text=No orders yet". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for [data-testid="empty-orders-message"], text=No tienes pedidos, text=No orders yet
