...
- Name: specs\admin-journey.spec.ts >> Admin Complete Journey >> Admin can view and update order status in table view
- Location: e2e\specs\admin-journey.spec.ts:53:3
