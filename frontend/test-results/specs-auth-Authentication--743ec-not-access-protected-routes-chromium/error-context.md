...
- Name: specs\auth.spec.ts >> Authentication >> Logged out user cannot access protected routes
- Location: e2e\specs\auth.spec.ts:66:3
...
Received string:  "http://localhost:5173/orders"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    8 × unexpected value "http://localhost:5173/orders"
