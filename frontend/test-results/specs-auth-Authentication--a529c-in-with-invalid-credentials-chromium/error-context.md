...
- Name: specs\auth.spec.ts >> Authentication >> User cannot login with invalid credentials
- Location: e2e\specs\auth.spec.ts:15:3
...
Locator: [data-testid="error-message"], .error, text=Credenciales incorrectas
Expected: visible
Error: Unexpected token "=" while parsing css selector "[data-testid="error-message"], .error, text=Credenciales incorrectas". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for [data-testid="error-message"], .error, text=Credenciales incorrectas
